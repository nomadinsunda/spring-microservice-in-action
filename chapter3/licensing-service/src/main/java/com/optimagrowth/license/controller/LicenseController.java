...
//				
	...
	// Helper method to add a method attribute
    private Link createLinkWithMethod(String method, String href) {
        return Link.of(href).withRel(method);
    }
}
